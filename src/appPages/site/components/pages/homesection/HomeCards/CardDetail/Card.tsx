          ...
          <div className={scss.content}>
            ...
            <div className={scss.detailContent}>
              <div className={scss.bookContent}>
                <Image
                  src={data.book_images?.[0]?.book_images || defaultBook}
                ...
                <div className={scss.cardInfo}>
                  <div className={scss.bookNameBlock}>
                    <h1 className={scss.bookName}>{data.book_name}</h1>
                    <h2 className={scss.authorName}>{data.author}</h2>
                  </div>
                  ...
                  <Image
                    width={150}
                    height={30}
                    src={STAR_RATINGS[Math.floor(data.average_rating)] || star0}
                  ...
                  <div className={scss.bookActAndDesBlock}>
                    <h1 className={scss.description}>{data.description}</h1>
            ...
            <div className={scss.rating}>
              ...
              <div className={scss.ratingContent}>
                <p className={scss.ratingUsers}>Оценок: {data.total_ratings}</p>
              </div>
            </div>
          </div>
        </div>
