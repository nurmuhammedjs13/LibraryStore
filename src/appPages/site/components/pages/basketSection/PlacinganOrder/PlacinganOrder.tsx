...
const PlacinganOrder = () => {
  ...
  const { data: deliveryList, error: deliveryError } = useGetRegDeliveryQuery();
    ...
    cartData.forEach((item) => {
      ...
      if (seen.has(key)) {
        ...
        const updatedItem: CartItem = {
          ...
          quantity: uniqueItems[existingItemIndex].quantity + item.quantity,
        };
...
//////// +/-
 ...
 const handleQuantityChange = async (id: number, currentQuantity: number, increment: boolean) => {
   ...
   const scrollContainer = itemElement?.closest('.cart-items-container') as HTMLElement | null || window;
          ...
          if (item && item.id) {
            try {
              ...
              if (
                ...
                console.warn(`Товар с id ${item.id} уже удалён.`);
              } else {
                throw error;
              }
            }
...
💭 *Комментарий*: ${
        orderData.text ? sanitizeText(orderData.text) : "Нет комментария"
      }`;
  ...
  const handleSubmitOrder = async (e: FormEvent) => {
    ...
    try {
      ...
      commonFormData.append("client_first_name", formData.firstName.trim());
      ...
      if (activeButton === "delivery") {
        ...
        if (formData.address) {
          commonFormData.append("client_address", formData.address.trim());
        }
        ...
        try {
          ...
          console.log("Пробуем фиксированный формат для API самовывоза...");
          ...
          console.log("Пробуем отправить JSON для самовывоза:", pickupData);
          ...
          try {
            ...
            console.error("Ошибка при использовании JSON:", jsonError);
            setValidationError(
  ...
  const handleInputChange = (
    ...
    if (type === "file") {
      ...
      if (!sanitizedValue.startsWith("+996")) {
        sanitizedValue = "+996" + sanitizedValue.replace(/^\+?996?/, "");
      }
    ...
    <div className={styles.mainBlock}>
      <div className="container">
        <div className={styles.block}>
              ...
              >
                <div className={styles.ImgBlock}>
                  <div className={styles.img}>
                    <Image
                      src={item.books.book_images[0].book_images}
          ...
          <form onSubmit={handleSubmitOrder} className={styles.mainInput}>
            ...
            <div className={styles.InputBlock}>
              ...
              <div className={styles.uploadFile}>
                <div className={styles.text1}>
                  <h4>Товары: {calculateTotalQuantity()}шт</h4>
